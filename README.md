...
## Usage
1. Download the latest `dylib` from the [releases](https://github.com/kissalexandra/InAnyCase/releases)
2. Inject the `dylib`:
    - CLI: `DYLD_INSERT_LIBRARIES=<ABSOLUTE_DYLIB_PATH> <APP_BINARY_PATH>`

> [!IMPORTANT]
> You may need to use `sudo -i` when injecting via the CLI, if you get a "permission denied" error.
...
1. Install the dependencies:
    - `Xcode`: 13 or later
    - `cmake`: 3.10 or later
2. Clone the project: `git clone --recursive https://github.com/kissalexandra/InAnyCase.git && cd ./InAnyCase/`
...
## License
[GPL-3.0](https://github.com/kissalexandra/InAnyCase/blob/main/COPYING)
